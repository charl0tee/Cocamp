<?php 
	...
	$requetPetitesAnnonces = "SELECT Annonce.IdAnn, Annonce.TitreAnn, Annonce.PrixAnn, Annonce.CatAnn, Annonce.DescrAnn, Localisation.VilleLocal, Annonce.DateAnn, Image.UrlImage FROM Annonce, Localisation, Image WHERE Localisation.IdLocal=Annonce.IdLocal AND Image.IdAnn=Annonce.IdAnn AND CatAnn='PetiteAnnonce'";
	$resultPetitesAnnonces = mysql_query($requetPetitesAnnonces) or die ("Erreur de la base de données.");
