jQuery(document).ready(function ($) {
	...
	$(".connect").click(function() {
		if ($(this).hasClass('opened')) {
			$(this).removeClass('opened');
			$('.connnect a').removeClass('activeated_connect');
			$('.c_form').fadeOut('slow').removeClass('animated expandOpen').addClass('animated expandOpen');
		} else {
			$(this).addClass('opened');
			$('.connect a').addClass('activeated_connect');
			$(".c_form").fadeIn('slow').removeClass('animated expandOpen').addClass('animated expandOpen');
		}
	});
	$("body").click(function() {
		$('.connect').removeClass('opened');
		$('.connect a').removeClass('activeated_connect');
		$('.c_form').fadeOut('slow').removeClass('animated expandOpen').addClass('animated expandOpen');
	});
